<script>
	$(".vouch_search").select2(); // Search of voucher no using select method 
			// Datepicker 
	...
	function home_voucher()
	{
		$('#voucher_home').html('<br><div style="text-align: center;"><img src="/UCO/images/loader/loader.gif"></div>');
		 $.ajax({
					type: "POST",
					url: "/UCO/new_voucher/voucher_cat.php",	 
	...
	function edit(code)
	{
		$('#newmember_adj_right').html('<br><div style="text-align: center;"><img src="/UCO/images/loader/loader.gif"></div>');
		var voucher_code=code; 		
		$.ajax({
			type:'GET',
			data: 'voucher_code='+voucher_code,
			url: 'new_voucher/Update/edit_voucher.php',
			success:function(data)
			{
	...
	{ 
	 $.ajax({
		type: "GET",
		data: 'voucher_code='+voucher_code,
		url: "/UCO/new_voucher/Voucher_Approve/voucherview.php",	 
		success: function(data)
		{
			$('#newmember_adj_right').html(data);	
		}
	...
	function voucher_search()
	{
		...
		url: "/UCO/new_voucher/voucher_search_view.php",	 
		success: function(data){
			$('#voucher_home').html(data);	
			}
		});	
