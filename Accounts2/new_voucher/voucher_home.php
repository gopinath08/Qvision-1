...
$vouch_res=$con->query("SELECT code,date,voucher_category_code,voucher_purpose_code,slip_no,reference_voucher,member_no, name,branch_code,reference_no,ledger_code,amount,bank_code,cheque_no,cheque_date,description,narration,status FROM accounts_voucher order by id desc limit 0,1");
...
$v_sql=$con->query("SELECT ledger_code,reference,amount,type,narration,status FROM voucher_detail WHERE 
