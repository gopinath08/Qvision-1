...
<form method="POST" action="Qvision/Recruitment/staff_asset/staff_asset_submit.php">
...
<!--td>System Or LapTop HOD:</td>

<td colspan="2"><select class="form-control" name="sys_hod">
		<option value="0">-- Select System Or LapTop HOD --</option>
		<?php
		$dep_sql=$con->query("SELECT * FROM staff_master");
		while($dep_sql_res=$dep_sql->fetch(PDO::FETCH_ASSOC))
		{
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/Recruitment/staff_asset/staff_asset.php",
