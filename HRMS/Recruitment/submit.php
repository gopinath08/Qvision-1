    ...
    if($valid == 1){ 
       // $uploadStatus = 1; 
		...
		$uploadedFileStr3 = trim($uploadedFile, ','); 
		   ...
		   VALUES ('".$candidateid."', '".$position."', '".$name."', '".$fathers_name."', '".$DOB."', '".$communication_address."', '".$permanent_address."', '".$mobile_num."', '".$email_id."', '".$uploadedFileStr."', '".$adharnumber."', '".$uploadedFileStr1."', '".$pannumber."', '".$uploadedFileStr2."', '".$voternumber."', '".$uploadedFileStr3."', '".$status."', '".$candidateid."', now())"); 
