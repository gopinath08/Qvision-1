...
$row = $stmt->fetch();
$id=$row['asset'];
//$iid=$row['details_of_handing_over'];
?>
...
<form role="form" name="" action="Qvision/Recruitment/staff_asset_master/update_staff_asset_master.php" method="post" enctype="multipart/type">
...
<?php
$dep_sql1=$con->query("SELECT * FROM staff_asset_master where id='$id' ");
$fet=$dep_sql1->fetch();
?>
...
<input type="submit" name="submit" class="btn btn-primary btn-md" style="float:right;">
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/Recruitment/staff_asset_master/staff_asset_master.php",
