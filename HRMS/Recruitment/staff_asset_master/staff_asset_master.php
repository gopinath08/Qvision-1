...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/Recruitment/staff_asset_master/new_staff_asset_master.php",
 ...
 function staff_asset_edit(v)
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/Recruitment/staff_asset_master/edit_staff_asset_master.php?id="+v,
    success:function(data){
    $(".content").html(data);
    }
    })
