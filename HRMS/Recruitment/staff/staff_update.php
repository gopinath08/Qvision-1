...
$user=$_SESSION['userid'];
 $candidid=$_REQUEST['cid'];
  ...
  $date=date('Y-m-d');
  $update=$con->query("update staff_master set emp_name='$cname', dep_id='$deprt', div_id='$div', design_id='$desig',modified_by='$user',modified_on='$date' where candid_id='$candidid'");
