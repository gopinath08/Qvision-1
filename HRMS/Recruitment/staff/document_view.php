...
//echo "select * from emp_personal_details  where id='$candidateid'";
$data=$sql->fetch();
?>

<div class="content-wrapper" id="mydiv"style="padding-left: 50px;">
...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <td colspan="1"><a href="images/uploads/<?php echo $data['adharcard_number']; ?>" download="<?php echo $data['adharcard_number']; ?>"><?php echo $data['adharcard_number']; ?></a></td>
        </tr>
        <tr>
        <td>Pan Number:</td>
        <td colspan="4"><input type="text" class="form-control" id="pannumber" name="pannumber" value="<?php echo $data['pan_number'];?>"readonly></td>
        <td colspan="1"><a href="images/uploads/<?php echo $data['pan_number']; ?>" download="<?php echo $data['pan_number']; ?>"><?php echo $data['pan_number']; ?></a></td>
        </tr>
        <tr>
        <td>Voter ID:</td>
        <td colspan="4"><input type="text" class="form-control" id="voternumber" name="voternumber" value="<?php echo $data['Voter_no'];?>" readonly></td>
        <td colspan="1"><a href="images/uploads/<?php echo $data['Voter_no']; ?>" download="<?php echo $data['Voter_no']; ?>"><?php echo $data['Voter_no']; ?></a></td>
        </tr>
        <tr>
        <td>Resume:</td>
        <td colspan="5"><a href="images/uploads/<?php echo $data['resume']; ?>" download="<?php echo $data['resume']; ?>"><?php echo $data['resume']; ?></a></td>
        </tr>
        <!--tr>  
        <td colspan="6">
