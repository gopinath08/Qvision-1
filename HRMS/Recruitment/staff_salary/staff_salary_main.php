...
function scale_changes(v)
{
	...
	$.ajax({
		type:"GET",
		url:"HRMS/Recruitment/staff_salary/staff_earnings_view.php?earning_id="+v+"&salary_amount="+salary_amount,
 ...
 function staff_salary_save()
{
	...
	type:'GET',
	data:"id="+id, data,
	  url:"HRMS/Recruitment/staff_salary/staff_salary_update.php",
		success:function(data)
		{
			if(data==1)
			{
