   ...
   <form method="POST" enctype="multipart/form-data">
    ...
    <tr>
	  ...
	  <label>
        ...
        <td>Aadhar Number: *</td>
        <td colspan="4">
		<input type="text" class="form-control" id="adharnumber" name="adharnumber" onchange="validation()" required>
		</td>
        </tr>
        <!--tr>
        <td>Pan Number:</td>
       ...
       <tr>
		...
		<tr id='employee_new1'>
		<td>Percentage</td>
        <td colspan="4"><input type="text" class="form-control" id="percentage" name="percentage"></td>
        </tr>
		<tr>
...
function resource_formS()
{
	...
	$.ajax({
		...
		url:'/Qvision/Qvision/resource/resource_form/resource_form_submit.php',
