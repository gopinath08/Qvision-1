 ...
 <div class="row">
   ...
   <div class="panel-body">
    ...
    <thead>
      ...
      <tbody>
      <?php
      $emp_sql=$con->query("SELECT *,s.id as sid FROM resource_form_detail s left join designation_master d on s.position=d.id join source_master sm on s.source=sm.id where s.status=1");
      $i=1;
...
<script>
 ...
 <script>
 	...
 	$.ajax({
	type:"POST",
	url:"/Qvision/Qvision/resource/resource_form/resource_view.php?id="+v,
	success:function(data)
	{
	  ...
	  {		 
		  $.ajax({
	type:"POST",
	url:"/Qvision/Qvision/resource/resource_form/interview_schedule.php?id="+v,
	success:function(data)
	{
		$('#table_view').html(data);
	}
