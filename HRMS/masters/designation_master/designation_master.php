...
<div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Designation Master List</h1>
                        </div>
                        </div>
						<div class="row">
						 <div class="col-lg-12">
		  <a onclick=" add_designation()" style="float: right;" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> ADD</a>
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/masters/designation_master/new_designation.php",
  ...
  function designation_edit(v)
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/masters/designation_master/edit_designation.php?id="+v,
    success:function(data){
    $(".content").html(data);
    }
    })
