...
<script>
   function newdepartment_mapping()
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/masters/department_mapping/new_department_mapping.php",
  ...
  function question_edit(v)
    ...
    $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/masters/department_mapping/edit_department_mapping.php?id="+v,
    success:function(data){
    $(".content").html(data);
    }
    })
