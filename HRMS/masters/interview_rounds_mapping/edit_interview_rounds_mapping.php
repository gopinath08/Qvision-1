...
<form role="form" name="" action="Qvision/masters/interview_rounds_mapping/update_interview_rounds_mapping.php" method="GET" enctype="multipart/type">
...
<?php
$dep_sql1=$con->query("SELECT * FROM interview_rounds where id='$iid' ");
$fet=$dep_sql1->fetch();
?>
