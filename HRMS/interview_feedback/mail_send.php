...
$mail->FromName = 'Qvision Job Portal';
$mail->addAddress("laxmipriya@bluebase.in");     // Add a recipient
$mail->WordWrap = 50;                                 // Set word wrap to 50 characters
$mail->isHTML(true);                                 // Set email format to HTML
$subject="Qvision - Candidate Personal Details Required";			
	...
	$html_table .=' </table>';
	$html_table .='<button class="btn btn-primary"><a href="http://49.249.229.14/Qvision">Login Portal</a></button>';
