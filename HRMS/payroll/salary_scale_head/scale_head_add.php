...
{	
	...
	$.ajax({
		...
		url:'Qvision/payroll/salary_scale_head/scale_head_details.php',
...
function scale_head_back()
{
	$.ajax({
    type:"GET",
    url:'Qvision/payroll/salary_scale_head/scale_head_main.php',
    success:function(data){
...
function scale_data_save()
{
	...
	url:'Qvision/payroll/salary_scale_head/scale_head_insert.php',
		success:function(data)
		{
			if(data == 1)
			{
