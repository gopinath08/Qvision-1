...
<div class="tab-content">
   ...
   <table class="table table-bordered">
        ...
        <tr>
        <td>Vendor Name</td>
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter Vendor Name" id="txt_vendor_name" name="txt_vendor_name" value="<?php echo $row['vendor_name'];?>"></td>
        </tr>
