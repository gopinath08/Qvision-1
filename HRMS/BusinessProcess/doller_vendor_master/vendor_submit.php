...
$sql11=$con->query("insert into doller_vendor_mastor(vendor_name,address1,address2,area,town_city,state,district,country,pincode
...
echo "insert into doller_vendor_mastor(vendor_name,address1,address2,area,town_city,state,district,country,
  account_name,account_no,swift_code,ifsc_code,mail_id,status,created_by,created_on)
  values('$txt_vendor_name','$txt_address1','$txt_address2','$txt_area',
  '$txt_town','$txt_state','$txt_district','$txt_country','$txt_account_name','$txt_account_no','$txt_swift_code','$txt_ifsc_code','$txt_mailid',
  '$status','$user_id',NOW() )";
?>