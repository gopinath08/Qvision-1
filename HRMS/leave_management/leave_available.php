...
function leave_management()
{
  $.ajax({
    type:"POST",
    url:"/Qvision/Qvision/leave_management/main.php",
...
function leave_check(value)
{
  $.ajax({
    type:"GET",
    data:"value="+value,
    url:"/Qvision/Qvision/leave_management/check_leave.php",
    success:function(data){
...
function Leave_create()
{
	...
	$.ajax({
		...
		url:'/Qvision/Qvision/leave_management/Leave_new_submit.php',
		success:function(data)
		{
			if(data==0)
			{
