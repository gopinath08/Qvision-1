...
include("../../user.php");
$id=$_REQUEST['id'];
$stmt = $con->prepare("SELECT enquiry.id as enquiry_id,enquiry.mail as enquiry_mailid,enquiry.*,calls_master.*,z_department_master.*,candidate_form_details.*  FROM `enquiry`
                ...
                <div class="card-body">
				  <div class="form-group row">
				   ...
				   <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="Client_Type" id="Client_type" value="<?php echo  $row['Client_type'];?>"readonly>
                    </div>
                  </div>
				  <div class="form-group row">
...
<div class="form-group row">
			  ...
			  <input type="text" class="form-control" name="companys" id="companys" value="Quadsel Systems Private Limited"  readonly>
...
$cnt=$cnt+1;
	  ...
	  <br>
              ...
              <input type="button" class="btn btn-primary" id="save" name="save" onclick="Quote_status()" value="Send Quote">
 ...
 var data = $('form').serialize();
    ...
    url:'Qvision/CRM/quote_enquiry.php',
    success:function(data)
    {
      if(data==1)
      { 
