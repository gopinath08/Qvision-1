...
?>
	...
	<option value="0">InActive</option>
	   ...
	   <div class="card-header"> 
	<input type="button" class="btn btn-primary btn-md" onclick="emp_deduction_create()" value="SAVE">
...
//alert("nnn");
	 $.ajax({
    type:"POST",
    url:"deduction/emp_deduction.php",
 ...
 function emp_deduction_create()
{
	...
	type:'GET',
	data:"id="+id, data,
	  url:"deduction/emp_deduction_insert.php",
		success:function(data)
		{
			if(data==1)
			{
