...
?>
	...
	<i class="fa fa-table"></i>EMPLOYER DEDUCTION ADD
	...
	<option value="0">InActive</option>
	   ...
	   <div class="card-header"> 
	<input type="button" class="btn btn-primary btn-md" onclick="employer_deduction_create()" value="SAVE">
...
//alert("nnn");
	 $.ajax({
    type:"POST",
    url:"deduction/employer_deduction.php",
 ...
 function employer_deduction_create()
{
	...
	type:'GET',
	data:"id="+id, data,
	  url:"deduction/employer_deduction_insert.php",
		success:function(data)
		{
			if(data==1)
			{
